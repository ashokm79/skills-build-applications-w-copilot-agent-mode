      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-primary mb-4">
        <div className="container-fluid">
          <Link className="navbar-brand fw-bold d-flex align-items-center" to="/">
            <img src="/logo.png" alt="Octofit Logo" className="App-logo me-2" />
            Octofit Tracker
          </Link>
            ...
            <div className="text-center mt-5">
              ...
              <div className="card mx-auto mt-4" style={{maxWidth: '400px'}}>
                <div className="card-body">
                  ...
                  <p className="card-text">Use the navigation menu to explore activities, teams, users, workouts, and leaderboard.</p>
